...
export const NETWORK = "devnet"; //process.env.NODE_ENV === "production" ? "mainnet" : "devnet";
...
export const activeGamesList: {
  ...
  devnet: [
    ...
    {
      worldId: new anchor.BN(2296),
      worldPda: new PublicKey("EKSNX9gJHVkAPPHeUwQUdxN2zkj3m5k3u7t8ngLoFwRG"),
